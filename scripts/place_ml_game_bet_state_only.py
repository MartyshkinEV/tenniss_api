...
def main() -> None:
    ...
    for market in markets:
        # LayeredGamePredictor builds the live-state feature frame internally.
    ...
    if best is None:
        raise SystemExit("State-only ML analysis did not produce a valid next_game_winner candidate")

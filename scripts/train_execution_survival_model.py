...
def main():
    ...
    result = train_binary_classifier(frames.execution_survival, target_name="execution_survival")
    output_path = settings.models_dir / "execution_survival_model.joblib"
    metadata_path = settings.models_dir / "execution_survival_model.json"
